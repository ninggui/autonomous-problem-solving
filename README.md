...
**遭遇问题时先搜索再执行，失败后分析原因，只在确实需要用户介入时才回传。含SkillHub国内skill商店。**

[SkillHub 在线安装](https://skillhub.cn/skills/autonomous-problem-solving) · [快速使用](#快速使用) · [核心能力](#核心能力) · [使用边界](#使用边界)
...
```text
使用 autonomous-problem-solving 技能。
这是待处理内容，直接执行。
```
...
- 涉及「autonomous-problem-solving」的场景任务
- 需要复用已验证方法论的工作
- 批量/复杂任务中的专项环节
